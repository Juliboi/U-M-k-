const uMisku = document.querySelector('.nav-logo');
...
function smoothScroll(target, duration) {
  ...
  let targetPosition =
    section.getBoundingClientRect().top - nav.getBoundingClientRect().height; //where the element currently is
...
viz.addEventListener('click', specificate);
uMisku.addEventListener('click', specificate);
